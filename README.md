##Notes by Jenish
for this project I used json server for the data, you have to first start Json server (using json-server --watch db.json) and then nuxt.js(npm run dev) Project else it will give an error.

#after launching appliction you have to change path of add in router.js with routes:
 [{
    path: "/add/:id",
    component:  _37b43c70,
    name: "add"
...
#I used tailwind css for styling in this project.
#I used rounter link to link the pages. 
#I used pre-filling data for updating recored.
#I created Api using Json and tested with postman.
#I used axios for the data communication with json.
